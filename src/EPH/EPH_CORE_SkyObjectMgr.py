...
import src.EPH.EPH_SAT_SatelliteMgr as SatMgr
import src.EPH.EPH_PLANET_PlanetMgr as PlanetMgr
import src.EPH.EPH_STAR_StarMgr as StarMgr
import src.EPH.EPH_MOON_MoonMgr as MoonMgr
